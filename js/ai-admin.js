...
(function () {
  ...
  if (!document.getElementById('ai-admin-styles')) {
    ...
    st.textContent = [
      ...
      '.aia-model.on{border-color:var(--accent);background:var(--tint-accent,rgba(var(--accent-rgb),.10))}',
      ...
      '.aia-input:focus{outline:none;border-color:var(--accent);box-shadow:var(--ring,0 0 0 2px rgba(var(--accent-rgb),.25))}',
      ...
      '.aia-note.info{background:var(--tint-accent,rgba(var(--accent-rgb),.12));color:var(--accent-fg,var(--accent))}',
      ...
      '.aia-chip.verified{background:var(--tint-accent,rgba(var(--accent-rgb),.12));color:var(--accent-fg,var(--accent))}',
      ...
      '.aia-chip.health{background:var(--tint-accent,rgba(var(--accent-rgb),.16));color:var(--accent-fg,var(--accent));font-weight:700}',
      ...
      '.aia-ta:focus{outline:none;border-color:var(--accent);box-shadow:var(--ring,0 0 0 2px rgba(var(--accent-rgb),.25))}',
      ...
      '.aia-select:focus{outline:none;border-color:var(--accent);box-shadow:var(--ring,0 0 0 2px rgba(var(--accent-rgb),.25))}',
      ...
      '.aia-vcard.on{border-color:var(--accent);background:var(--tint-accent,rgba(var(--accent-rgb),.10))}',
