...
(function () {
  ...
  if (!document.getElementById('ai-tutor-styles')) {
    ...
    st.textContent = [
      ...
      '.tutor-persona.active{border-color:var(--accent);color:var(--text);background:var(--tint-accent,rgba(var(--accent-rgb),0.12))}',
      '.tutor-persona[aria-checked="true"]{border-color:var(--accent);color:var(--text);background:var(--tint-accent,rgba(var(--accent-rgb),0.12))}',
